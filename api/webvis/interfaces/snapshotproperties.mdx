...
status?: [SnapshotStatus](/api/webvis/enums/snapshotstatus)

Describes the availability and integrity status of a snapshot's referenced data.
See [SnapshotStatus](/api/webvis/enums/snapshotstatus) for more information about the possible values.
