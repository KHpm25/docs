...
* **Experimental** `{property: <property name>, <operator>: <value>}`: Nodes with a matching property value.
  The available property names are the string values of the [Property](/v3.14/api/webvis/enums/property) enum. This condition does not
...
* **Experimental** `property.<property name>`: The value of the specified property. The available property
  names are the string values of the [Property](/v3.14/api/webvis/enums/property) enum. Note: this selector is experimental and may be
