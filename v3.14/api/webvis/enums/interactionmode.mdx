...
The default interaction mode. Will also be set when [InteractionAPI.resetInteractionMode](/v3.14/api/webvis/interfaces/interactionapi#resetinteractionmode) is being called.
