...
The backend address is defined by [SettingStrings.HUB\_URL](/api/webvis/enums/settingstrings#hub_url).
...
* [ServiceConnectionLostEvent](/api/webvis/classes/serviceconnectionlostevent): This event occurs when the connection to a service gets lost.
* [ServiceErrorEvent](/api/webvis/classes/serviceerrorevent): This event occurs when the service goes into an error.
* [ServiceStateChangedEvent](/api/webvis/classes/servicestatechangedevent): This event occurs when the state of a service changes.
