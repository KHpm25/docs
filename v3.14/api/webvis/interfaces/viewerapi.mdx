...
can be found in the [ViewerSettingStrings](/v3.14/api/webvis/enums/viewersettingstrings).
...
However, if you are interested in subscribing to view changes, you can listen to the [ViewChangedEvent](/v3.14/api/webvis/classes/viewchangedevent):
...
* changeSetting<[T](#changesettingt) extends string>(  
  ...
  Triggers a [ViewerSettingChangedEvent](/v3.14/api/webvis/classes/viewersettingchangedevent) if the new value is different from the old value.
  ...
  [ViewerSettingStrings](/v3.14/api/webvis/enums/viewersettingstrings) for a list of available viewer settings.
...
* enableNavigation(flag?: boolean): void
  ...
  use [ViewerSettingStrings.NAVIGATION\_MODE](/v3.14/api/webvis/enums/viewersettingstrings#navigation_mode) instead
...
* enterColorCompareMode(): void
  ...
  Enters the color compare mode which renders nodes depending on their [Property.COMPARISON\_GROUP](/v3.14/api/webvis/enums/property#comparison_group).

  In the color compare mode, the viewer will render the pixels of nodes with the [Property.COMPARISON\_GROUP](/v3.14/api/webvis/enums/property#comparison_group)
  set to the value [ComparisonGroup.A](/v3.14/api/webvis/enums/comparisongroup#a) in the color specified by the
  [ViewerSettingStrings.COLOR\_COMPARISON\_FIRST\_COLOR](/v3.14/api/webvis/enums/viewersettingstrings#color_comparison_first_color) setting. The pixels of nodes with the
  [Property.COMPARISON\_GROUP](/v3.14/api/webvis/enums/property#comparison_group) set to the value [ComparisonGroup.B](/v3.14/api/webvis/enums/comparisongroup#b) will be rendered in the color
  specified by the [ViewerSettingStrings.COLOR\_COMPARISON\_SECOND\_COLOR](/v3.14/api/webvis/enums/viewersettingstrings#color_comparison_second_color) setting.
  ...
  [ViewerSettingStrings.COLOR\_COMPARISON\_MATCHING\_COLOR](/v3.14/api/webvis/enums/viewersettingstrings#color_comparison_matching_color) setting.
  ...
  + [InteractionMode.COLOR\_COMPARISON](/v3.14/api/webvis/enums/interactionmode#color_comparison)
...
* fitView(  
  ...
  Triggers a [ViewChangedEvent](/v3.14/api/webvis/classes/viewchangedevent).
...
* fitViewToAuxNode(nodeID: number, transitionTime?: number): Promise\<void>
  ...
  [NodeType.AUX](/v3.14/api/webvis/enums/nodetype#aux)

### fitViewToDirection

* fitViewToDirection(  
      direction?: [ViewDirection](/v3.14/api/webvis/enums/viewdirection),  
      transitionTime?: number,  
  ): Promise\<void>

  Positions the camera such that it looks from a specific [ViewDirection](/v3.14/api/webvis/enums/viewdirection).
  The optional `transitionTime` parameter allows for controlling animation speed.
  ...
  + `Optional`direction: [ViewDirection](/v3.14/api/webvis/enums/viewdirection)

    The direction to fit. Default: [ViewDirection.CURRENT](/v3.14/api/webvis/enums/viewdirection#current).
  + `Optional`transitionTime: number
...
* fitViewToVolumeFromDirection(  
  ...
  Positions the camera such that it looks from the specified [ViewDirection](/v3.14/api/webvis/enums/viewdirection) onto the specified BoxVolume.
  The optional `transitionTime` parameter allows for controlling animation speed.
...
* forceRenderMode(renderMode: [RenderMode](/v3.14/api/webvis/enums/rendermode)): void

  Forces the viewer to render in the specified [RenderMode](/v3.14/api/webvis/enums/rendermode) regardless of any other [RenderMode](/v3.14/api/webvis/enums/rendermode) settings.
  If [RenderMode.Unset](/v3.14/api/webvis/enums/rendermode#unset) is passed, the viewer will switch back to the default mode, specified in
  [ViewerSettingStrings.RENDER\_MODE](/v3.14/api/webvis/enums/viewersettingstrings#render_mode).
...
* getCameraProjectionType(): [CameraProjectionType](/v3.14/api/webvis/enums/cameraprojectiontype)

  Returns the current [CameraProjectionType](/v3.14/api/webvis/enums/cameraprojectiontype) of the camera.

  #### Returns [CameraProjectionType](/v3.14/api/webvis/enums/cameraprojectiontype)

  The current camera projection type.

  #### See

  [ViewerSettingStrings.PROJECTION\_TYPE](/v3.14/api/webvis/enums/viewersettingstrings#projection_type)
...
* getInteractionLevel(): [ViewerInteractionLevel](/v3.14/api/webvis/enums/viewerinteractionlevel)

  Returns the current interaction level of the viewer.

  #### Returns [ViewerInteractionLevel](/v3.14/api/webvis/enums/viewerinteractionlevel)
...
* requestXRAutoDetectScores(nodeIDs: number[]): Promise\<XRAutoDetectScore[]>
  ...
  Request scores caluclated based on the ratio of matching/non-matching pixels of the XR Edge Compare feature. Passed nodes must be in [XR Edge Compare mode](/v3.14/api/webvis/enums/comparisongroup#xr_edge) mode to produce a valid score. Multiple concurrent requests of this method are not allowed.
...
* resetSetting(viewerSetting: [ViewerSettingStrings](/v3.14/api/webvis/enums/viewersettingstrings)): void

  Resets the value of a viewer setting to its default value.

  Triggers a [ViewerSettingChangedEvent](/v3.14/api/webvis/classes/viewersettingchangedevent).

  #### Parameters

  + viewerSetting: [ViewerSettingStrings](/v3.14/api/webvis/enums/viewersettingstrings)
...
* restoreInitView(): void
  ...
  Sets the camera to the initial position specified in the [ViewerSettingStrings.INIT\_VIEW](/v3.14/api/webvis/enums/viewersettingstrings#init_view) setting.
  If the setting is not defined or empty, there will be no effect.

  Triggers a [ViewChangedEvent](/v3.14/api/webvis/classes/viewchangedevent) if the [ViewerSettingStrings.INIT\_VIEW](/v3.14/api/webvis/enums/viewersettingstrings#init_view) setting is set.
...
* setInteractionLevel(level: [ViewerInteractionLevel](/v3.14/api/webvis/enums/viewerinteractionlevel)): void

  Sets the viewer's interaction level.

  #### Parameters

  + level: [ViewerInteractionLevel](/v3.14/api/webvis/enums/viewerinteractionlevel)
