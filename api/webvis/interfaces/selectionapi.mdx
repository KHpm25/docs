...
The property [Property.SELECTED](/api/webvis/enums/property#selected) can be used to check the selection state of a node.
...
* [SelectionChangedEvent](/api/webvis/classes/selectionchangedevent): Triggered when the selection changes.
