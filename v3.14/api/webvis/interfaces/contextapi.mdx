...
* anchorXR(xrAnchorOptions?: XRAnchorOptions): void
  ...
  This will trigger a [XRStateChangedEvent](/v3.14/api/webvis/classes/xrstatechangedevent) with XRState.anchored set to `true`.
...
* changeClippingRoom(properties?: ClipRoomProperties): ClipRoomProperties
  ...
  Triggers a [ClippingRoomChangedEvent](/v3.14/api/webvis/classes/clippingroomchangedevent) when properties are modified.
...
* changeClipPlane(  
  ...
  Triggers a [ClipPlaneChangedEvent](/v3.14/api/webvis/classes/clipplanechangedevent) when properties are modified.
...
* changeSnapshot(  
  ...
  Triggers a [SnapshotChangedEvent](/v3.14/api/webvis/classes/snapshotchangedevent).
...
* createClippingRoom(properties?: ClipRoomProperties): void
  ...
  Triggers a [ClippingRoomCreatedEvent](/v3.14/api/webvis/classes/clippingroomcreatedevent) when the clip room is created.
...
* createClipPlane(properties?: ClipPlaneProperties): number
  ...
  Triggers a [ClipPlaneCreatedEvent](/v3.14/api/webvis/classes/clipplanecreatedevent) when the clip plane is created.
...
* createSnapshot(  
  ...
  Triggers a [SnapshotCreationStartedEvent](/v3.14/api/webvis/classes/snapshotcreationstartedevent) and, if successful, a [SnapshotCreatedEvent](/v3.14/api/webvis/classes/snapshotcreatedevent).
...
* deleteMemberProfileEntry(key: string): Promise\<void>
  ...
  Triggers a [MemberProfileEntryChangedEvent](/v3.14/api/webvis/classes/memberprofileentrychangedevent) if successful.
...
* enterXRInitMode(xrInitOptions?: XRInitOptions): Promise\<void>
  ...
  snapped, the XRState.anchored value will be set to `true` which will trigger a [XRStateChangedEvent](/v3.14/api/webvis/classes/xrstatechangedevent).
  ...
  Please note, that this method should only be called if the XR system has the [XRCapability.SUPPORTS\_MODEL\_TRACKING](/v3.14/api/webvis/enums/xrcapability#supports_model_tracking) capability.
...
* exportXRInitTemplate(): Promise\<string>
  ...
  This method is only available if the XR system has the [XRCapability.SUPPORTS\_MODEL\_TRACKING](/v3.14/api/webvis/enums/xrcapability#supports_model_tracking) capability.
...
* getProperties<[T](#getpropertiest) extends string>(  
  ...
  ): Promise<[PropertyType](/v3.14/api/webvis/types/propertytype)<[T](#getpropertiest)>[]>
  ...
  #### Returns Promise<[PropertyType](/v3.14/api/webvis/types/propertytype)<[T](#getpropertiest)>[]>
...
* getProperty<[T](#getpropertyt) extends string>(  
  ...
  ): Promise<[PropertyType](/v3.14/api/webvis/types/propertytype)<[T](#getpropertyt)>>
  ...
  #### Returns Promise<[PropertyType](/v3.14/api/webvis/types/propertytype)<[T](#getpropertyt)>>
...
* getXRCapabilities(): [XRCapability](/v3.14/api/webvis/enums/xrcapability)[]

  `Experimental`

  Get the array of [XRCapability](/v3.14/api/webvis/enums/xrcapability). The array of capabilities determines what parts of the API can be used. The capabilities
  are mostly defined by the used device.

  #### Returns [XRCapability](/v3.14/api/webvis/enums/xrcapability)[]

  Returns an Array<[XRCapability](/v3.14/api/webvis/enums/xrcapability)> containing the XR system's capabilities.
...
* hideXRBackgroundFeed(): Promise\<void>
  ...
  This will trigger a [XRStateChangedEvent](/v3.14/api/webvis/classes/xrstatechangedevent) with XRState.backgroundFeedVisible set to `false`.
...
* registerFrameListener(listener: [FrameListener](/v3.14/api/webvis/types/framelistener)): void
  ...
  + listener: [FrameListener](/v3.14/api/webvis/types/framelistener)
...
* registerListener<[T](#registerlistenert) extends [WebVisEvent](/v3.14/api/webvis/classes/webvisevent) = [WebVisEvent](/v3.14/api/webvis/classes/webvisevent)>(  
      eventTypes: [EventType](/v3.14/api/webvis/enums/eventtype)[],  
      listener: IEventListener<[T](#registerlistenert)>,  
      nodeID?: number,  
      observeSubTree?: boolean,  
  ): number

  Registers a listener for a set of [EventType](/v3.14/api/webvis/enums/eventtype)s. If the given event types array is empty, the
  listener will react to all event types. The listener must implement the IEventListener
  interface. It will be called with events that extend the [WebVisEvent](/v3.14/api/webvis/classes/webvisevent) base class. An event's
  `type` property specifies its [EventType](/v3.14/api/webvis/enums/eventtype) and determines its structure.

  ### Scoping listeners in the node hierarchy

  Several [EventType](/v3.14/api/webvis/enums/eventtype)s are linked to a specific node in the hierarchy. These include all that
  ...
  + [NODE\_ADDED](/v3.14/api/webvis/enums/eventtype#node_added) events are linked to the parent node of the added node.
  + [NODE\_CHANGED](/v3.14/api/webvis/enums/eventtype#node_changed) events behave differently depending on the node property
...
* removeClippingRoom(safe?: boolean): [RemoveState](/v3.14/api/webvis/enums/removestate)
  ...
  Triggers a [ClippingRoomRemovedEvent](/v3.14/api/webvis/classes/clippingroomremovedevent) when the clip room is successfully removed.
...
* removeClipPlane(clipPlaneId: number, safe?: boolean): [RemoveState](/v3.14/api/webvis/enums/removestate)
  ...
  Triggers a [ClipPlaneRemovedEvent](/v3.14/api/webvis/classes/clipplaneremovedevent) when the clip plane is successfully removed.
...
* removeSnapshot(snapshotID: number): void
  ...
  Triggers a [SnapshotRemovedEvent](/v3.14/api/webvis/classes/snapshotremovedevent).
...
* requestMemberActions(memberId: number): Promise<[MemberAction](/v3.14/api/webvis/enums/memberaction)[]>
  ...
  [MemberActionAddedEvent](/v3.14/api/webvis/classes/memberactionaddedevent) and [MemberActionRemovedEvent](/v3.14/api/webvis/classes/memberactionremovedevent).
  ...
  #### Returns Promise<[MemberAction](/v3.14/api/webvis/enums/memberaction)[]>
...
* requestNodePathStrings(  
  ...
      scope?: number,  
      typePriorities?: [NodePathFragmentType](/v3.14/api/webvis/enums/nodepathfragmenttype)[],  
  ): Promise\<string[]>
  ...
  + `Optional`typePriorities: [NodePathFragmentType](/v3.14/api/webvis/enums/nodepathfragmenttype)[]
...
* requestSpaceHandle(role?: [OWNER](/v3.14/api/webvis/enums/memberrole#owner) | [EDITOR](/v3.14/api/webvis/enums/memberrole#editor) | [VIEWER](/v3.14/api/webvis/enums/memberrole#viewer)): Promise\<SpaceHandle>
  ...
  + `Optional`role: [OWNER](/v3.14/api/webvis/enums/memberrole#owner) | [EDITOR](/v3.14/api/webvis/enums/memberrole#editor) | [VIEWER](/v3.14/api/webvis/enums/memberrole#viewer)

    The role to assign when the space is opened via the handle. If undefined, the
    [MemberRole.VIEWER](/v3.14/api/webvis/enums/memberrole#viewer) role will be assigned when opening the space via the handle.
...
* resetSetting(setting: [ViewerSettingStrings](/v3.14/api/webvis/enums/viewersettingstrings) | [SettingStrings](/v3.14/api/webvis/enums/settingstrings)): void

  Resets the value of a setting to the installation default.

  #### Parameters

  + setting: [ViewerSettingStrings](/v3.14/api/webvis/enums/viewersettingstrings) | [SettingStrings](/v3.14/api/webvis/enums/settingstrings)
...
* restoreSnapshot(  
  ...
  Triggers a [SnapshotRestoreStartedEvent](/v3.14/api/webvis/classes/snapshotrestorestartedevent) and, if successful, a [SnapshotRestoredEvent](/v3.14/api/webvis/classes/snapshotrestoredevent).
...
* seekXRPlayback(frameIndex: number): Promise\<void>
  ...
  Triggers a [XRPlaybackStateChangedEvent](/v3.14/api/webvis/classes/xrplaybackstatechangedevent).
...
* setLayerFilterEnabled(  
  ...
  Triggers a [LayerFilterChangedEvent](/v3.14/api/webvis/classes/layerfilterchangedevent).
...
* setMemberName(name: string): void
  ...
  Triggers a [MemberChangedEvent](/v3.14/api/webvis/classes/memberchangedevent) if the name changes.
...
* setMemberProfileEntry(key: string, value: [Serializable](/v3.14/api/webvis/types/serializable)): Promise\<void>

  `Experimental`

  Sets a profile entry of the local member.

  Triggers a [MemberProfileEntryChangedEvent](/v3.14/api/webvis/classes/memberprofileentrychangedevent) if the profile entry changes or is created.
  ...
  + value: [Serializable](/v3.14/api/webvis/types/serializable)
...
* setProperty<[T](#setpropertyt) extends string>(  
  ...
      value: [PropertyType](/v3.14/api/webvis/types/propertytype)<[T](#setpropertyt)>,  
      silent?: boolean,  
  ): Promise\<void>
...
* showXRBackgroundFeed(): Promise\<void>
  ...
  This will trigger a [XRStateChangedEvent](/v3.14/api/webvis/classes/xrstatechangedevent) with XRState.backgroundFeedVisible set to `true`.
...
* transferSession(progressCallback: [StoreSessionProgressCallback](/v3.14/api/webvis/types/storesessionprogresscallback)): Promise\<string>

  `Experimental`

  #### Parameters

  + progressCallback: [StoreSessionProgressCallback](/v3.14/api/webvis/types/storesessionprogresscallback)
...
* unanchorXR(): void
  ...
  This will trigger a [XRStateChangedEvent](/v3.14/api/webvis/classes/xrstatechangedevent) with XRState.anchored set to `false`.
...
* unregisterFrameListener(listener: [FrameListener](/v3.14/api/webvis/types/framelistener)): void
...
* useMemberAction<[A](#usememberactiona) extends [MemberAction](/v3.14/api/webvis/enums/memberaction)>(  
      memberId: number,  
  ...
  + A extends [MemberAction](/v3.14/api/webvis/enums/memberaction)
