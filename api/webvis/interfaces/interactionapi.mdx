...
switching between different predefined interaction modes [interaction modes](/api/webvis/enums/interactionmode).
...
* [InteractionModeChangedEvent](/api/webvis/classes/interactionmodechangedevent)
