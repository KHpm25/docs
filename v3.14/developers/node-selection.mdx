...
When you run a query, the API returns a [QueryResult](/v3.14/api/webvis/interfaces/queryresult) JSON object. This contains both the queried data and potential errors, should there be any. The data array it returns is formatted as you specified in the query selection, which means
