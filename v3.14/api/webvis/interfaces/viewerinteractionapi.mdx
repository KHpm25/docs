...
[NodeClickedEvent](/v3.14/api/webvis/classes/nodeclickedevent)s:
...
Get the current [interaction level](/v3.14/api/webvis/enums/viewerinteractionlevel) of a viewer:
...
For example, if the [ViewerInteractionLevel](/v3.14/api/webvis/enums/viewerinteractionlevel) is set to [ViewerInteractionLevel.TOPOLOGY](/v3.14/api/webvis/enums/viewerinteractionlevel#topology),
but the viewer's [ViewerSettingStrings.RENDER\_MODE](/v3.14/api/webvis/enums/viewersettingstrings#render_mode) is set to
[RenderMode.Faces](/v3.14/api/webvis/enums/rendermode#faces) only, then snapping to edges will not work. To enable
snapping to all topological entities, the render mode should be set to
[RenderMode.FacesTopology](/v3.14/api/webvis/enums/rendermode#facestopology) instead.

### Events

The `ViewerInteractionAPI` emits the following events:

* [BackgroundClickedEvent](/v3.14/api/webvis/classes/backgroundclickedevent)
* [NodeClickedEvent](/v3.14/api/webvis/classes/nodeclickedevent)
* [NodePointerEnterEvent](/v3.14/api/webvis/classes/nodepointerenterevent)
* [NodePointerOutEvent](/v3.14/api/webvis/classes/nodepointeroutevent)
* [NodePointerOverEvent](/v3.14/api/webvis/classes/nodepointeroverevent)
* [TopologyPointerEnterEvent](/v3.14/api/webvis/classes/topologypointerenterevent)
* [TopologyPointerOutEvent](/v3.14/api/webvis/classes/topologypointeroutevent)
