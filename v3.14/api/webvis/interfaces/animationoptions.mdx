...
playState?: [AnimationPlayState](/v3.14/api/webvis/enums/animationplaystate)
...
timingFunction?: [AnimationTimingFunction](/v3.14/api/webvis/enums/animationtimingfunction)
