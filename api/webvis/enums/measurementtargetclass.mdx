...
The available classes of [MeasurementTarget](/api/webvis/types/measurementtarget)s that can be used with the [MeasurementAPI](/api/webvis/interfaces/measurementapi).

#### See

* [MeasurementTarget](/api/webvis/types/measurementtarget)
* MeasurementType
...
A part of a geometry represented by a [TopologyHandle](/api/webvis/interfaces/topologyhandle). This includes shapes, faces, and edges.
