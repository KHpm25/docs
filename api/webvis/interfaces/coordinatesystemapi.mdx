...
All information are based on the [front plane axis setting](/api/webvis/enums/settingstrings#front_plane_axis) which defines the orientation of the
front plane of the model in the 3D space.

### Quick Start

To read out the current coordinate system as well as the currently set [front plane axis setting](/api/webvis/enums/settingstrings#front_plane_axis),
...
To change the transformations, change the [front plane axis setting](/api/webvis/enums/settingstrings#front_plane_axis):
...
* [SettingStrings.FRONT\_PLANE\_AXIS](/api/webvis/enums/settingstrings#front_plane_axis) for the corresponding setting
* [FrontPlaneAxis](/api/webvis/enums/frontplaneaxis) for all possible front plane values
