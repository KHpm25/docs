...
All available input types are defined in the [MeasurementTargetClass](/api/webvis/enums/measurementtargetclass) enum.

### Quick Start

To measure the distance between a point and a plane, we need to represent them as [MeasurementTarget](/api/webvis/types/measurementtarget)s
as follows:
...
For other target types, see [MeasurementTargetClass](/api/webvis/enums/measurementtargetclass). With these targets, we can now measure the
...
scenario are defined in the [MeasurementType](/api/webvis/enums/measurementtype) enum. Besides this function, this set also includes:
...
we can create a corresponding [MeasurementTarget](/api/webvis/types/measurementtarget) to use in measurements:
