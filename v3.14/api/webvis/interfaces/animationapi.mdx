...
* [AnimationStartedEvent](/v3.14/api/webvis/classes/animationstartedevent)
* [AnimationEndedEvent](/v3.14/api/webvis/classes/animationendedevent)
* [AnimationIterationEvent](/v3.14/api/webvis/classes/animationiterationevent)
* [AnimationFramesCreatedEvent](/v3.14/api/webvis/classes/animationframescreatedevent)
* [AnimationFramesRemovedEvent](/v3.14/api/webvis/classes/animationframesremovedevent)
