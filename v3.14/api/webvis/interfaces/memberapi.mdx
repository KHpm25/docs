...
profile entries of a member via the [MemberProfileEntryChangedEvent](/v3.14/api/webvis/classes/memberprofileentrychangedevent).
...
allow you to perform predefined operations on members, see [MemberAction](/v3.14/api/webvis/enums/memberaction)
for a list of available actions. Members can subscribe to changes of available actions on a member
via the [MemberActionAddedEvent](/v3.14/api/webvis/classes/memberactionaddedevent) and [MemberActionRemovedEvent](/v3.14/api/webvis/classes/memberactionremovedevent).
...
* [MemberActionAddedEvent](/v3.14/api/webvis/classes/memberactionaddedevent)
* [MemberActionRemovedEvent](/v3.14/api/webvis/classes/memberactionremovedevent)
* [MemberChangedEvent](/v3.14/api/webvis/classes/memberchangedevent)
* [MemberCreatedEvent](/v3.14/api/webvis/classes/membercreatedevent)
* [MemberProfileEntryChangedEvent](/v3.14/api/webvis/classes/memberprofileentrychangedevent)
* [MemberRemovedEvent](/v3.14/api/webvis/classes/memberremovedevent)
