...
Furthermore, please notice the difference between context and viewer level settings, as described in the [ViewerAPI](/v3.14/api/webvis/interfaces/viewerapi).
...
* [ViewerAPI.readSetting](/v3.14/api/webvis/interfaces/viewerapi#readsetting)
* [ViewerAPI.resetSetting](/v3.14/api/webvis/interfaces/viewerapi#resetsetting)
* [ViewerSettingChangedEvent](/v3.14/api/webvis/classes/viewersettingchangedevent)
...
Please use the SettingStrings.FRONT\_PLANE\_AXIS setting with the [SettingsAPI.changeSetting](/v3.14/api/webvis/interfaces/settingsapi#changesetting) function of the ContextAPI instead.
...
that are highlighted via the [ViewerHighlightAPI](/v3.14/api/webvis/interfaces/viewerhighlightapi) (for
...
[ViewerAPI.restoreInitView](/v3.14/api/webvis/interfaces/viewerapi#restoreinitview) to restore this initial view.
...
[ViewerAPI.forceRenderMode](/v3.14/api/webvis/interfaces/viewerapi#forcerendermode)
