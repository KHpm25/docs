...
entity has a general [type](/api/webvis/enums/topologytype) and a more specific [subtype](/api/webvis/enums/topologysubtype).
...
When the viewer interaction level is set to [TOPOLOGY](/api/webvis/enums/viewerinteractionlevel#topology)
via the function ViewerInteractionAPI.setInteractionLevel, webvis will emit
[TopologyPointerEnterEvent](/api/webvis/classes/topologypointerenterevent)s and [TopologyPointerOutEvent](/api/webvis/classes/topologypointeroutevent)s when the mouse
