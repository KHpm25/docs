...
Furthermore, please notice the difference between context and viewer level settings, as described in the [ContextAPI](/api/webvis/interfaces/contextapi).
...
* [ContextAPI.changeSetting](/api/webvis/interfaces/contextapi#changesetting)
* [ContextAPI.readSetting](/api/webvis/interfaces/contextapi#readsetting)
* [ContextAPI.resetSetting](/api/webvis/interfaces/contextapi#resetsetting)
* [SettingChangedEvent](/api/webvis/classes/settingchangedevent)
...
[QueryAPI.query](/api/webvis/interfaces/queryapi#query) - For executing queries against the model
...
* [ClipPlaneAPI.createCapping](/api/webvis/interfaces/clipplaneapi#createcapping) - For creating clipping geometries
* [ClipPlaneAPI.removeCapping](/api/webvis/interfaces/clipplaneapi#removecapping) - For removing existing capping geometries
...
[QueryAPI.query](/api/webvis/interfaces/queryapi#query) For more information on executing queries
...
When this setting changes, an [InteractionModeChangedEvent](/api/webvis/classes/interactionmodechangedevent) is triggered, allowing
applications to respond to the mode change. Applications can temporarily override this
setting by explicitly calling [InteractionAPI.setInteractionMode](/api/webvis/interfaces/interactionapi#setinteractionmode) with a specific
interaction mode.
...
[InteractionAPI.setInteractionMode](/api/webvis/interfaces/interactionapi#setinteractionmode) - To programmatically change interaction modes
...
[CoordinateSystemAPI](/api/webvis/interfaces/coordinatesystemapi) for methods to access the resulting vectors and matrices
...
[MeasurementAPI](/api/webvis/interfaces/measurementapi) - For performing measurements between geometric entities
...
[MeasurementAPI](/api/webvis/interfaces/measurementapi) - For performing measurements
...
[restoreSnapshot](/api/webvis/interfaces/sessionstorageapi#restoresnapshot) can override these defaults with specific options.
...
* [SessionStorageAPI.restoreSnapshot](/api/webvis/interfaces/sessionstorageapi#restoresnapshot) - For restoring snapshots with specific options
* [SessionStorageAPI.createSnapshot](/api/webvis/interfaces/sessionstorageapi#createsnapshot) - For creating snapshots
...
[URIMap](/api/webvis/types/urimap)
...
The images are made available through [XRModelTrackerEdgeImgReceivedEvent](/api/webvis/classes/xrmodeltrackeredgeimgreceivedevent) events and
...
* [XRModelTrackerEdgeImgReceivedEvent](/api/webvis/classes/xrmodeltrackeredgeimgreceivedevent) - Event that delivers the edge images
...
* [RealityAPI.connectXR](/api/webvis/interfaces/realityapi#connectxr) - For initializing AR functionality
...
tracking system must have before transitioning the [XRState.modelTrackingPhase](/api/webvis/interfaces/xrstate#modeltrackingphase) to
SNAPPED. When the confidence level exceeds this threshold:

1. The tracking state changes to XRModelTrackingPhase.SNAPPED.
2. The XR system automatically sets [XRState.anchored](/api/webvis/interfaces/xrstate#anchored) to `true`.
