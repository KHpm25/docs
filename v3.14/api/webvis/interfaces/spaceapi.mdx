...
handle, users who open the space via the handle are assigned the [VIEWER](/v3.14/api/webvis/enums/memberrole#viewer) role by default.
...
* [SpaceChangedEvent](/v3.14/api/webvis/classes/spacechangedevent)
