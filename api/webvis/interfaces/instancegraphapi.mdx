...
* [CustomPropertyRegisteredEvent](/api/webvis/classes/custompropertyregisteredevent)
* [NodeAddedEvent](/api/webvis/classes/nodeaddedevent)
* [NodeChangedEvent](/api/webvis/classes/nodechangedevent)
* [NodeErrorEvent](/api/webvis/classes/nodeerrorevent)
* [NodePropertiesResetEvent](/api/webvis/classes/nodepropertiesresetevent)
* [NodeRemovedEvent](/api/webvis/classes/noderemovedevent)
...
* getProperties<[T](#getpropertiest) extends string>(  
      nodeID: number,  
      properties: T[],  
  ): Promise<[PropertyType](/api/webvis/types/propertytype)\<T>[]>
  ...
  #### Returns Promise<[PropertyType](/api/webvis/types/propertytype)\<T>[]>
...
* setProperty<[T](#setpropertyt) extends string>(  
  ...
      property: T,  
      value: [PropertyType](/api/webvis/types/propertytype)\<T>,  
      silent?: boolean,  
  ): Promise\<void>
