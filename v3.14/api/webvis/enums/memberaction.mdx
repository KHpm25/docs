...
It can be used via [MemberAPI.useMemberAction](/v3.14/api/webvis/interfaces/memberapi#usememberaction).
...
Kicks the target member from the [space](/v3.14/api/webvis/interfaces/spaceapi).
