...
colorScheme?: [CustomHeatmapColorScheme](/v3.14/api/webvis/types/customheatmapcolorscheme) | [HeatmapColorScheme](/v3.14/api/webvis/enums/heatmapcolorscheme)
...
kernel?: [HeatmapKernel](/v3.14/api/webvis/enums/heatmapkernel)
